...
datasets = {
    "Swordplay": {
        ...
        "motif_length": 120,
        "amc_name": "02_07",
        "asf_path": str(motion_data_path / "02.asf"),
        "slack": 1.0,
        "used_joints": [
    ...
    "Basketball": {
        ...
        "motif_length": 50,
        "amc_name": "06_02",
        "asf_path": str(motion_data_path / "06.asf"),
        "slack": 1.0,
        "used_joints": [
            'rclavicle', 'rhumerus', 'rradius', 'rwrist', 'rhand', 'rfingers', 'rthumb',
            'rfemur', 'rtibia', 'rfoot', 'rtoes'
    ...
    "Boxing": {
        ...
        "n_dims": 7,
        "slack": 0.5,
        "asf_path": str(motion_data_path / "13.asf"),
        "used_joints": [
            'rclavicle', 'rhumerus', 'rradius', 'rwrist', 'rhand', 'rfingers', 'rthumb',
            'rfemur', 'rtibia', 'rfoot', 'rtoes'
        ]
    ...
    "Charleston - Side By Side Female": {
        ...
        "amc_name": "93_04",
        "slack": 0.5,
        "asf_path": str(motion_data_path / "93.asf"),
        "used_joints": [
...
def get_ds_parameters(name):
    ...
    amc_path = str(motion_data_path / f"{amc_name}.amc")
...
def test_lama(
    ...
    for a, i in enumerate(ks):
        ...
        motiflet = np.sort(motif)
        print(f"Motif {a + 1} positions [s]: {format_seconds(motiflet / 120)}")
