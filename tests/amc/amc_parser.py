# for amc motion capturing data reading / visualization - can be used to show single frames
...
class Joint:
    ...
    def set_motion(self, motion):
        if self.name == 'root':
            ...
            self.matrix = self.parent.matrix.dot(self.C).dot(euler2mat(*rotation)).dot(
                self.Cinv)
